...
Write-Host "🚀 Starting Food Delivery Application..." -ForegroundColor Green
Write-Host ""
...
# Start Frontend
Start-ServiceInNewWindow -Title "Frontend React App" -Command "npm start" -WorkingDirectory "c:\Download\food_app\food-delivery-app\frontend"
